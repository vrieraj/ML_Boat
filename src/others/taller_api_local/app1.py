...
app = Flask(__name__)
app.config["DEBUG"] = True # solo deberemos hacerlo cuando estemoes trabajando en local, no en entornos productivos
...
# Ejemplo: http://127.0.0.1:5000/api/v1/resources/books?id=2
...
# Este metodo no es robusto pues es key sensitive. Se podría mejorar para que sea mas robusto
